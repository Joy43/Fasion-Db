        ...
        <View className="flex-1 justify-center items-center bg-black bg-opacity-50">
          <View className="bg-white rounded-xl p-6 w-11/12 max-h-[80%]">
            <ScrollView>
              ...
              <Text>
                <Text className="font-semibold">Name:</Text> {profile?.name}
              </Text>
              <Text>
              ...
              <Text>
                <Text className="font-semibold">Last Login:</Text>{" "}
                {profile?.lastLogin}
              </Text>
              ...
              <Text>
                ...
                {profile?.clientInfo?.browser}
              </Text>
              <Text>
                <Text className="font-semibold">IP Address:</Text>{" "}
                {profile?.clientInfo?.ipAddress}
              </Text>
              <Text>
              ...
              <Text>
                <Text className="font-semibold">OS:</Text>{" "}
                {profile?.clientInfo?.os}
              </Text>
              <Text>
                <Text className="font-semibold">User Agent:</Text>{" "}
                {profile?.clientInfo?.userAgent}
              </Text>
            </ScrollView>
